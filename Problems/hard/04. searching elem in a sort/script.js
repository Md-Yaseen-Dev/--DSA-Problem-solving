...
// BasicAccuracy: 48.03%Submissions: 149K+Points: 1
...
console.log(searchInSorted([1, 3, 4, 5, 6], 5, 2));
console.log(searchInSorted([1, 2, 3, 4, 6], 5, 6));

// --for loop

function searchInSorted1(arr, N, K) {
...
console.log(searchInSorted1([1, 3, 4, 5, 6], 5, 2));
console.log(searchInSorted1([1, 2, 3, 4, 6], 5, 6));